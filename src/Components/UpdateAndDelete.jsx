...
//     const isArrayField = ["actorNames", "genre", "coActor"].includes(name);
//     const newValue = isArrayField ? value.split(",").map(v => v.trim()) : value;
...
//       console.log("Token:", token);
//       await axios.put(
//         `https://backend-1h5d.onrender.com/api/updated/${id}`,
//         {
//           ...movie,
...
//       <input type="text" name="genre" className="update-delete-text" value={movie.genre} onChange={handleChange} placeholder="Genres (comma-separated)" />
...
//       <input type="text" name="actorNames" className="update-delete-text" value={movie.actors?.map(actor => actor.name).join(", ") || ""} onChange={handleChange} placeholder="Actor Names" />
//       <input type="text" name="coActor" className="update-delete-text" value={movie.coActor} onChange={handleChange} placeholder="Co-Actors (comma-separated)" />
